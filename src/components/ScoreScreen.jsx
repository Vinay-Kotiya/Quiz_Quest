      ...
      {step === "scoreScreen" && (
        ...
        >
          <div className="text-center space-y-6 bg-white text-gray-800 p-8 rounded-2xl shadow-lg">
            ...
            <button
              onClick={() => setStep("questionsScreen")}
              className="group/button relative inline-flex items-center m-3 justify-center overflow-hidden rounded-3xl bg-[#1DCD9F] backdrop-blur-lg px-6 py-2  font-semibold text-white transition-all duration-300 ease-in-out hover:scale-110 hover:shadow-xl hover:shadow-gray-700 border border-black"
            >
              <span className="md:text-2xl text-xl">Check your Answers</span>
            ...
            <button
              onClick={onRestart}
              className="group/button relative inline-flex items-center justify-center m-3 overflow-hidden rounded-3xl bg-[#1DCD9F] backdrop-blur-lg px-6 py-2  font-semibold text-white transition-all duration-300 ease-in-out hover:scale-110 hover:shadow-xl hover:shadow-gray-700 border border-black"
            >
              <span className="md:text-2xl text-xl">Play Again</span>
              <div className="absolute inset-0 flex h-full w-full justify-center [transform:skew(-13deg)_translateX(-100%)] group-hover/button:duration-1000 group-hover/button:[transform:skew(-13deg)_translateX(100%)]">
                <div className="relative h-full w-10 bg-white/20"></div>
              </div>
            </button>
      ...
      {step === "questionsScreen" && (
        <div className="text-center h-full w-full  items-center flex justify-center flex-col space-y-6 bg-transparent text-gray-800 md:p-8 p-2 rounded-2xl z-50 shadow-lg">
          <div className="text-center md:w-[70%] space-y-6 bg-white text-gray-800 md:p-8 p-2 rounded-2xl shadow-lg">
            ...
            <button
              onClick={() => setStep("scoreScreen")}
              className="group/button relative inline-flex items-center justify-center overflow-hidden rounded-3xl bg-[#1DCD9F] backdrop-blur-lg px-6 py-2 text-2xl font-semibold text-white transition-all duration-300 ease-in-out hover:scale-110 hover:shadow-xl hover:shadow-gray-700 border border-black"
            >
              <span className="md:text-3xl text-2xl">Close</span>
              <div className="absolute inset-0 flex h-full w-full justify-center [transform:skew(-13deg)_translateX(-100%)] group-hover/button:duration-1000 group-hover/button:[transform:skew(-13deg)_translateX(100%)]">
                <div className="relative h-full w-10 bg-white/20"></div>
              </div>
            </button>
